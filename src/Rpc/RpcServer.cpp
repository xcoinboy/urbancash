...
bool RpcServer::on_get_index(const COMMAND_HTTP::request& req, COMMAND_HTTP::response& res) {
  const std::string index_start =
    R"(<html><head><meta http-equiv='refresh' content='60'/></head><body><img src="https://updates.urbancash.org/images/logos/logo256x256.png" alt="URBC" class="logo-img"><p>" 
)" "urbancash" R"(d &bull; version )";
